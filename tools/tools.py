...
class Tools(commands.Cog):
    ...
    async def laban(self, ctx, member:Union[discord.Member, str]):
        ...
        #main labs lafc labsevents spain, academy, asia, bd, derucula, support, portugal, ff, ff thunder
        guilds = [440960893916807188, 401883208511389716, 593248015729295360, 654334199494606848, 460550486257565697, 473169548301041674, 663716223258984496, 593732431551660063, 631888808224489482, 594736382727946250, 616673259538350084, 560028292783276032, 561181224547123207]
